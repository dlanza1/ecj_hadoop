...
/**
 * Parity implements the family of <i>n</i>-[even|odd]-Parity problems up to
 * 32-parity. Read the README file in this package for information on how to set
 * up the parameter files to your liking -- it's a big family.
 * 
 * <p>
 * The Parity family evolves a boolean function on <i>n</i> sets of bits, which
 * returns true if the number of 1's is even (for even-parity) or odd (for
 * odd-parity), false otherwise.
 * 
 * <p>
 * <b>Parameters</b><br>
 * <table>
 ...
 * <td valign=top>(the class for the prototypical GPData object for the Parity
 * problem)</td>
 * </tr>
 * <tr>
 * <td valign=top><i>base</i>.<tt>even</tt><br>
 * <font size=-1> bool = <tt>true</tt> (default) or <tt>false</tt></font></td>
 * <td valign=top>(is this even-parity (as opposed to odd-parity)?)</td>
 * </tr>
 * <tr>
 * <td valign=top><i>base</i>.<tt>bits</tt><br>
 * <font size=-1> 2 &gt;= int &lt;= 31</font></td>
 * <td valign=top>(The number of data bits)</td>
 * </tr>
 * </table>
 * 
 * <p>
	...
	public void setup(final EvolutionState state, final Parameter base) {
		...
		if (!(input instanceof ParityData))
			state.output.fatal("GPData class must subclass from "
					+ ParityData.class, base.push(P_DATA), null);

		// can't use all 32 bits -- Java is signed. Must use 31 bits.
		numBits = state.parameters.getIntWithMax(base.push(P_NUMBITS), null, 2,
				31);
		if (numBits < 2)
			state.output
					.fatal("The number of bits for Parity must be between 2 and 31 inclusive",
							base.push(P_NUMBITS));
